    ...
    <section class="h-full">
        <div class="px-6 h-half text-gray-800">
            ...
            <div class="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
                ...
                >
                    <p class="text-center text-xl font-semibold mx-4 mb-0">ВХОД В ТРЕНАЖЕР</p>
                </div>
                ...
                <div class="text-center lg:text-left">
                    ...
                    <div v-if="isError" class="bg-red-100 rounded-lg mt-2 py-5 px-6 mb-4 text-base text-red-700 mb-3" role="alert">
    ...
    login() {
      ...
      axios.get('/sanctum/csrf-cookie').then(response => {
          ...
          .catch (err =>{
            console.log(err)
            this.isError = true
            this.errorMessage = typeof (err.response.data) === 'object'  ? err.message : err.response.data
          })
      });
    }
  },
