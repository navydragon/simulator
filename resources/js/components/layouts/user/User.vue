          ...
          <div class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-gray-800">
            ...
            <div class="mt-5 flex-1 h-0 overflow-y-auto">
              <nav class="px-2 space-y-1">
                <router-link :to="item.href" v-for="item in navigation" :key="item.name"  :class="[item.current ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white', 'group flex items-center px-2 py-2 text-base font-medium rounded-md']">
				...
				<div v-if="user.role == 'admin'">
					<hr class="text-white">
					<h4 class="text-white group flex items-center px-2 py-2 text-base font-medium rounded-md">Администрирование</h4>
					<router-link :to="item.href" v-for="item in adminNavigation" :key="item.name"  :class="[item.current ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white', 'group flex items-center px-2 py-2 text-sm font-medium rounded-md']">
